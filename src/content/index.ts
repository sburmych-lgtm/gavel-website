...
export const site = {
  ...
  description:
    "Персональні тренування у Львові та онлайн. Майстер спорту України з веслування, 26 років у спорті, 16 — тренером. Перша консультація безкоштовна.",
} as const;
...
export const proof = [
  ...
  { value: "16", label: "років тренерства" },
  { value: "2 ×", label: "Майстер спорту України" },
  { value: "Європа", label: "чемпіон" },
] as const;
...
export const formats = {
  ...
  rows: [
    ...
    },
    {
      ...
      where: "Вода",
      body: "Техніка гребка від майстра спорту з каное та Dragonboat.",
    },
  ],
...
export const pricing = {
  ...
  lead: "Первинна консультація — безкоштовно. Далі — тільки якщо ми обидва бачимо, що це має сенс.",
  tiers: [
    {
      name: "Консультація",
      price: "0",
  ...
  note: "Місячні пакети в датасеті вказані в доларах, разове заняття — у гривні. Актуальну суму підтверджуємо на консультації.",
  limit:
    "Не працюю з людьми, яким медично протипоказані навантаження в тренажерному залі.",
} as const;
...
export const athlete = {
  ...
  paragraphs: [
    ...
    "Двадцять шість років ця дисципліна відбирала все зайве — і саме вона стоїть за тим, як побудовані тренування.",
  ],
} as const;
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Беру, якщо навантаження не протипоказані медично. Працюю з реабілітаційним тренінгом і поставою. Якщо лікар заборонив зал — це не до мене.",
    },
    {
...
export const contact = {
  ...
  lead: "Напишіть у Instagram — відповім особисто. Перша консультація безкоштовна і ні до чого не зобов'язує.",
  cta: { label: "Написати в Instagram", href: site.instagram },
  formNote:
    "Форма в цьому прототипі не надсилає повідомлення — робочий канал зв'язку — Instagram.",
  fields: [
